<?php
/**
 * Class file for MatchBlocksSourceTest
 *
...
final class MatchBlocksSourceTest extends Test_Case {
	...
	public function test_empty_source() {
		$this->assertEmpty( match_blocks( self::factory()->post->create( [ 'post_content' => '' ] ) ) );
	}
